...
6. iOS/Android 구분: WHERE platform = 'ios' 또는 platform = 'android' (파티션 컬럼)
7. Athena(Trino) 금지 함수:
   - COUNTIF() → COUNT_IF() 또는 SUM(CASE WHEN ... THEN 1 ELSE 0 END)
   - SAFE_DIVIDE() → TRY(a/b) 또는 CASE WHEN b=0 THEN 0 ELSE a/b END
   - IFNULL() → COALESCE()
