...
│       ├── athena-query/         # Athena 쿼리 실행 Lambda 인프라
│       └── agent-ui/             # AgentCore Web UI 호스팅 인프라
...
│   ├── Sources/RumSDK/           # SDK 소스 (RumSDK.swift, collectors/, models/)
│   └── Tests/                    # 단위 테스트
├── mobile-sdk-android/           # Android RUM SDK (Kotlin, Gradle)
│   └── rum-sdk/src/              # SDK 소스 (RumSDK.kt, collectors/, models/)
