...
- EC2 user_data는 Node.js 20 설치 및 환경 설정만 수행 — 실제 앱 배포는 별도 (CodeDeploy 또는 git)
...
- EC2 user_data only installs Node.js 20 and sets up environment — actual app deployment is separate (CodeDeploy or git)
